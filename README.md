...
<h4>5) In the Inspector, edit the ammount of trees you want to add to the scene and check "on", or "off" the "Use Parallelism To Generate bool.</h4>
...
<h4>7) When done, check the console for the time it took.</h4>
